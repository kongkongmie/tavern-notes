...
assert.match(html, /id="tavern-notes-notice"/);
assert.match(html, /id="tavern-notes-share-custom-background"/);
assert.match(html, /id="tavern-notes-share-custom-text-color"/);
